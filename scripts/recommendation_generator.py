from tweet_fetcher import fetch_tweets_after_time
import sys
sys.path.append('../services/src')
from db_helper import DbHelper
from db_helper import Tweet
import classifier
import datetime
...
def generate_recommendations(twitter_handle):
    ...
    classified_tweets = classifier.classify_tweets(tweet_text_list)
...
# helper = DbHelper()
# helper.get_user_affinity_score(3)